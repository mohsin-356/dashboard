import { ArrowRight, ArrowUp, DollarSign, Eye, ShoppingCart, User } from 'lucide-react'
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
      {
        stats.map((stat, index) => {
          return (
            <div key={index} className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl p-6
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className='text-3xl font-bold text-slate-800 dark:text-slate-200 mb-4'>
                    {stat.value}
                  </p>
